...
In this equation:
  ...
  * Parameter *b*<sub>0</sub> is the intercept and *b*<sub>1</sub> is the slope. Both are known as the **regression coefficients** and we will refer at them in the next sections. 
...
We can se that the variable SES does not appear to have a linear distribution since we can see a point cloud where it look as if there are two subsets. 
